...
public class SwerveModule {
    ...
    private void configAngleMotor(){
        ...
        mAngleMotor.configPeakOutputForward(0.5);
        mAngleMotor.configPeakOutputReverse(-0.5);
        resetToAbsolute();
    }
    ...
    public void setAngleMotor(double position){
        mAngleMotor.set(ControlMode.Position, Conversions.degreesToFalcon(position, Constants.Swerve.angleGearRatio));
    }
    ...
    public void goRotations(double rotations){
        mDriveMotor.set(ControlMode.Position, rotations*2048*Constants.Swerve.driveGearRatio);
    }

    public void goMeters(double meters){
        goRotations(meters/(0.1016*Math.PI));
    }

    public void goFeet(double feet){
        goRotations(feet/(Math.PI/3));
    }

    public void goInches(double inches){
        goRotations(inches/(4*Math.PI));
    }
