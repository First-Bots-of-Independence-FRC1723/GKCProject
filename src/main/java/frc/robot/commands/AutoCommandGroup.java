  ...
  public AutoCommandGroup(DriveSubsystem driveSubsystem, HoodSubsystem hoodSubsystem, ShooterSubsystem shooterSubsystem, TransportSubsystem transportSubsystem, IntakeSubsystem intakeSubsystem) {
    ...
    if(Robot.autoNumber.getDouble(-1738) == 1){
      addCommands(
        ...
        new DriveDistanceCommand(driveSubsystem, new Translation2d(-0.2, 0.1), 1, 2),
        new WaitTimeCommand(1),
        ...
        new ParallelCommandGroup(
          ...
          new DriveDistanceCommand(driveSubsystem, new Translation2d(0.2, 0), 1, 2),
        ...
        new WaitTimeCommand(1),
        new DirectionalDriveCommand(driveSubsystem, new Translation2d(0.2, 0), 2), 
        new ShootCommand(shooterSubsystem, true, 2.6),
        new ParallelCommandGroup(
          new TransportCommand(transportSubsystem, true, 2),
          new ShootCommand(shooterSubsystem, true, 2)
        )
      ...
      addCommands(
        ...
        new WaitTimeCommand(1),
        new DirectionalDriveCommand(driveSubsystem, new Translation2d(0.2, 0.1), 2),
        new WaitTimeCommand(1),
